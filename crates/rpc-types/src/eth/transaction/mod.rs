...
use atoms_consensus::{SignableTransaction, Signed, TxLegacy};
use base_primitives::{Bytes, IcanAddress, Signature, TxKind, B256, U256};

use serde::{Deserialize, Serialize};

pub use atoms_eips::eip2930::{AccessList, AccessListItem, AccessListWithGasUsed};
...
mod receipt;
pub use atoms_consensus::{AnyReceiptEnvelope, Receipt, ReceiptWithBloom};
...
pub struct Transaction {
    ...
    /// Energy amount
    #[serde(with = "atoms_serde::num::u128_via_ruint")]
    pub energy: u128,
    ...
    #[serde(default, with = "atoms_serde::u64_via_ruint")]
    pub network_id: u64,
