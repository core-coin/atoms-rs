...
mod tests {
    ...
    fn test_invalid_json_structure() {
        let invalid_json = r#"{
            "0x00001234567890123456789012345678901234567890": {
                "balance": true
            }
        }"#;
    ...
    fn test_state_override() {
        let s = r#"{
            "0x00000000000000000000000000000000000000000124": {
    ...
    fn test_state_override_state_diff() {
        let s = r#"{
                "0x00001b5212AF6b76113afD94cD2B5a78a73B7d7A8222": {
                    "balance": "0x39726378b58c400000",
                    "stateDiff": {}
                },
                "0x0000dAC17F958D2ee523a2206206994597C13D831ec7": {
                    "stateDiff": {
