...
impl TraceResults {
    /// Sets the energy used of the root trace.
    ///
    /// The root trace's energyUsed should mirror the actual energy used by the transaction.
    ///
    /// This allows setting it manually by consuming the execution result's energy for example.
    pub fn set_root_trace_energy_used(&mut self, energy_used: u64) {
        if let Some(r) = self.trace.first_mut().and_then(|t| t.result.as_mut()) {
            r.set_energy_used(energy_used)
        }
    }
}
...
#[derive(Clone, Debug, Default, PartialEq, Eq, Serialize, Deserialize)]
#[serde(transparent)]
pub struct StateDiff(pub BTreeMap<IcanAddress, AccountDiff>);

impl Deref for StateDiff {
    type Target = BTreeMap<IcanAddress, AccountDiff>;
...
pub struct CallAction {
    ...
    /// The energy available for executing the call.
    pub energy: U64,
...
pub struct CreateAction {
    ...
    pub from: IcanAddress,
    /// The energy available for the creation init code.
    pub energy: U64,
    /// The init code.
    pub init: Bytes,
...
pub struct SelfdestructAction {
    ...
    pub refund_address: IcanAddress,
}
...
impl TraceOutput {
    /// Returns the energy used by this trace.
    pub const fn energy_used(&self) -> U64 {
        match self {
            TraceOutput::Call(call) => call.energy_used,
            TraceOutput::Create(create) => create.energy_used,
        }
    }

    /// Sets the energy used by this trace.
    pub fn set_energy_used(&mut self, energy_used: u64) {
        match self {
            TraceOutput::Call(call) => call.energy_used = U64::from(energy_used),
            TraceOutput::Create(create) => create.energy_used = U64::from(energy_used),
        }
    }
}
...
pub struct VmInstruction {
    /// The energy cost for this instruction.
    pub cost: u64,
...
mod tests {
    ...
    fn test_transaction_trace() {
        let s = r#"{
            "action": {
                "from": "000066e29f0b6b1b07071f2fde4345d512386cb66f5f",
                "callType": "call",
                "energy": "0x10bfc",
                ...
                "to": "0000160f5f00288e9e1cc8655b327e081566e580a71d",
                "value": "0x244b"
            },
            "error": "Reverted",
            "result": {
    ...
    fn test_selfdestruct_suicide() {
        let input = r#"{
            "action": {
                "address": "0x000066e29f0b6b1b07071f2fde4345d512386cb66f5f",
                "refundAddress": "0x000066e29f0b6b1b07071f2fde4345d512386cb66f5f",
                "balance": "0x244b"
            },
            "error": "Reverted",
            "result": {
    ...
    fn test_serialization_order() {
        let test_cases = vec![
            TraceTestCase {
                trace: LocalizedTransactionTrace {
                    trace: TransactionTrace {
                        action: Action::Call(CallAction {
                            from: "00004f4495243837681061c4743b74b3eedf548d56a5".parse::<IcanAddress>().unwrap(),
                            call_type: CallType::DelegateCall,
                            energy: U64::from(3148955),
                            ...
                            to:  "000099b5fa03a5ea4315725c43346e55a6a6fbd94098".parse::<IcanAddress>().unwrap(),
                            value: U256::from(0),
                        }),
                        error: None,
                        result: Some(TraceOutput::Call(CallOutput { energy_used: U64::from(32364), output: Bytes::new() })),
                        subtraces: 0,
                ...
                expected_json: json!({
                    "action": {
                        "from": "0x00004f4495243837681061c4743b74b3eedf548d56a5",
                        ...
                        "to": "0x000099b5fa03a5ea4315725c43346e55a6a6fbd94098",
                        "value": "0x0"
                    },
            ...
            TraceTestCase {
                ...
                expected_json: json!({
                    ...
                    "blockNumber": 18557272,
                    "result": {
                        "address": "0x00007eb6c6c1db08c0b9459a68cfdcedab64f319c138",
  ...
  "action": {
    "from": "0x0000c77820eef59629fc8d88154977bc8de8a1b2f4ae",
    "callType": "call",
    "energy": "0x4a0d00",
    "input": "0x12",
    "to": "0x00004f4495243837681061c4743b74b3eedf548d56a5",
    "value": "0x0"
  },
  "blockHash": "0xd5ac5043011d4f16dba7841fa760c4659644b78f663b901af4673b679605ed0d",
  "blockNumber": 18557272,
  ...
  "type": "call"
    ...
    fn test_deserialize_serialize_selfdestruct() {
        let reference_data = r#"{
  "action": {
    "address": "0x0000c77820eef59629fc8d88154977bc8de8a1b2f4ae",
    "balance": "0x0",
    "refundAddress": "0x00004f4495243837681061c4743b74b3eedf548d56a5"
  },
  "blockHash": "0xd5ac5043011d4f16dba7841fa760c4659644b78f663b901af4673b679605ed0d",
  "blockNumber": 18557272,
  "result": {
