...
This crate contains the `Provider` trait, which exposes Core JSON-RPC
...
parameterized with a `Network` from [`atoms-networks`]. This allows the Provider
